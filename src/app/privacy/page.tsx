    ...
    <div style={{ padding: '40px 20px', fontFamily: 'inherit' }}>
      ...
      <div style={{ fontSize: 15, lineHeight: 1.8, color: 'var(--dim)' }}>
        <p style={{ marginBottom: '24px' }}>
          Приложение Loop уважает вашу приватность. Мы не передаем ваши данные третьим лицам без вашего согласия.
        </p>
        ...
        <p style={{ marginBottom: '24px' }}>
          Приложение предназначено для взрослых пользователей. Используя Loop, вы подтверждаете, что вам не менее 18 лет.
        </p>
      </div>
